...
\end{equation}
In order to convert the resulting equation (\ref{eqn:intStdConvDiffDiscr}) into a system of algebraic equations, differencing schemes is used.\\
\\
...
\end{tikzpicture}
\caption{Simulation set-up. \\ \textit{Simulations are done by varying speeds $U$ at constant $h/D = 1$, $1.5$ and $2$. Densities $\rho_0$ and $\rho_1$ are that of fresh and salt water respectively in stratified fluid simulations. For non-stratified fluid simulations, $\rho_0 = \rho_1$.}}
